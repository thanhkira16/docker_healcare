...
var buildUrlEmail = function buildUrlEmail(doctorId, token) {
  var results = "".concat(process.env.REACT_URL, "/verify-booking?token=").concat(token, "&doctorId=").concat(doctorId);
  return results;
};
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!(!data.email || !data.doctorId || !data.timeString || !data.timeType || !data.date || !data.birthday || !data.fullname || !data.doctorName || !data.language || !data.reason || !data.address || !data.reason || !data.selectedGender)) {
              _context.next = 6;
              break;
            }
            resolve({
          ...
          case 6:
            token = (0, _uuid.v4)();
            _context.next = 9;
            return _emailService["default"].sendBookingEmail({
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            resolve({
              errCode: 1,
              errMsg: "Missing required parameter from verify booking patient serviece"
            });
            _context2.next = 17;
            break;
          case 6:
